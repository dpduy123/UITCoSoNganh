...
CREATE DATABASE IF NOT EXISTS `congty` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `congty`;
--
...
CREATE TABLE `dean` (
  ...
  `MADA` tinyint(2) NOT NULL,
  `DIADIEM_DA` varchar(50) DEFAULT NULL,
  `PHONG` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`MADA`),
  KEY `DEAN-PHG_idx` (`PHONG`),
  CONSTRAINT `DEAN-PHG` FOREIGN KEY (`PHONG`) REFERENCES `phongban` (`MAPHG`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `diadiem_phg` (
  `MAPHG` tinyint(2) NOT NULL,
  `DIADIEM` varchar(45) NOT NULL,
  PRIMARY KEY (`MAPHG`,`DIADIEM`),
  CONSTRAINT `DIADIEM_PHG` FOREIGN KEY (`MAPHG`) REFERENCES `phongban` (`MAPHG`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nhanvien` (
  ...
  `PHG` tinyint(2) DEFAULT NULL,
  PRIMARY KEY (`MANV`),
  KEY `NV-PHG_idx` (`PHG`),
  KEY `NV-NV_idx` (`MA_NQL`),
  CONSTRAINT `NV-NV` FOREIGN KEY (`MA_NQL`) REFERENCES `nhanvien` (`MANV`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `NV-PHG` FOREIGN KEY (`PHG`) REFERENCES `phongban` (`MAPHG`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phancong` (
  ...
  `SODA` tinyint(2) NOT NULL,
  `THOIGIAN` float(4,2) NOT NULL,
  PRIMARY KEY (`MA_NVIEN`,`SODA`),
  KEY `PHANCONG_DEAN_idx` (`SODA`),
  CONSTRAINT `PHANCONG_DEAN` FOREIGN KEY (`SODA`) REFERENCES `dean` (`MADA`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `PHANCONG_NVIEN` FOREIGN KEY (`MA_NVIEN`) REFERENCES `nhanvien` (`MANV`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `phongban` (
  ...
  CONSTRAINT `PHG-NV` FOREIGN KEY (`TRPHG`) REFERENCES `nhanvien` (`MANV`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `thannhan` (
  ...
  CONSTRAINT `THANNHAN-MANV` FOREIGN KEY (`MA_NVIEN`) REFERENCES `nhanvien` (`MANV`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
